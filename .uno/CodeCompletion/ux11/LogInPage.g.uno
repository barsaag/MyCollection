...
public partial class LogInPage: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        var temp39 = new global::Fuse.Reactive.DataBinding(temp_Value_inst, temp2, __g_nametable, Fuse.Reactive.BindingMode.Default);
        var temp40 = new global::Fuse.Reactive.DataBinding(temp1_Value_inst, temp3, __g_nametable, Fuse.Reactive.BindingMode.Default);
        ...
        var temp43 = new global::Fuse.Controls.Circle();
        temp_eb2 = new global::Fuse.Reactive.EventBinding(temp4, __g_nametable);
        var temp44 = new global::Fuse.Controls.Button();
        ...
        temp9.Children.Add(temp38);
        temp9.Children.Add(temp41);
        temp10.Alignment = Fuse.Elements.Alignment.VerticalCenter;
        temp10.Margin = float4(140f, 140f, 140f, 140f);
        ...
        temp13.EasingBack = Fuse.Animations.Easing.CircularOut;
        temp14.X = -1f;
        temp14.Y = -1f;
        temp14.Duration = 0.2;
        ...
        temp38.Margin = float4(30f, 30f, 30f, 30f);
        ...
        temp41.Children.Add(LogIn);
        temp41.Children.Add(temp44);
        LogIn.Width = new Uno.UX.Size(75f, Uno.UX.Unit.Unspecified);
        LogIn.Height = new Uno.UX.Size(75f, Uno.UX.Unit.Unspecified);
        LogIn.Alignment = Fuse.Elements.Alignment.TopCenter;
        LogIn.Name = __selector26;
        global::Fuse.Gestures.Clicked.AddHandler(LogIn, temp_eb2.OnEvent);
        LogIn.Children.Add(temp42);
        LogIn.Children.Add(temp43);
        LogIn.Bindings.Add(temp_eb2);
        temp42.Value = "\uF084";
        temp42.FontSize = 32f;
        temp42.Color = Fuse.Drawing.Colors.Black;
        temp42.Alignment = Fuse.Elements.Alignment.Center;
        temp42.Font = global::LogInPage.FontAwesome;
        temp43.Color = float4(0.3921569f, 1f, 1f, 1f);
        temp44.Text = "SignIn";
        temp44.Alignment = Fuse.Elements.Alignment.BottomCenter;
        temp44.Margin = float4(10f, 10f, 10f, 10f);
        temp44.Padding = float4(10f, 10f, 10f, 10f);
        global::Fuse.Gestures.Clicked.AddHandler(temp44, temp_eb3.OnEvent);
        temp44.Bindings.Add(temp_eb3);
